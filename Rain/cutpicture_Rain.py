...
def process_frame(patchnum, split_name):
    ...
    try:
        ...
        gt_path = os.path.join(targetdir, "groundtruth", f"Rain_v2_{patchnum:04d}.bmp")
        in_path = os.path.join(targetdir, "input", f"Rain_v2_{patchnum}.jpg")
...
def build_median_background(targetdir, start_frame, end_frame, num_frames=150, size=(320, 240)):
    """
    ...
    for fid in range(first_frame, last_frame):
        ...
        img_path = os.path.join(targetdir, "input", f"Rain_v2_{fid}.jpg")
...
def preprocess():
    ...
    print(f"處理範圍: {total_start_frame} ~ {total_end_frame}") #修改範圍 更1
    ...
    for i in range(total_start_frame, total_end_frame): #修改範圍 更3
        ...
        img_path = os.path.join(targetdir, "input", f"Rain_v2_{i}.jpg")
    ...
    print("\n✅ 完成！")
    print(f"train/bg: {count_patches(os.path.join(filedir, 'train'))}")
    print(f"train/fg: {count_patches(os.path.join(filedir, 'train'))}")
    print(f"valid/bg: {count_patches(os.path.join(filedir, 'valid'))}")
    print(f"valid/fg: {count_patches(os.path.join(filedir, 'valid'))}")
    # print(f"test/bg: {count_patches(os.path.join(filedir, 'test'))}")
    # print(f"test/fg: {count_patches(os.path.join(filedir, 'test'))}")
